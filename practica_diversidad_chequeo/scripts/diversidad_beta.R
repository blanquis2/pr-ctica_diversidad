...
jaccard(data1)###Da valores que no correspondenXXXXXXX

##Guardar los datos una carpeta con terminación .csv
write.csv(mat_jaccard,file = "mat_dist_csv/matriz1_prueba1_indxJaccard.csv")
...
jac<-function(datos){
  ...
  write.csv(matd_jac,file = "mat_dist_csv/matriz2_distancia_indxJaccard_oficial.csv")
}
